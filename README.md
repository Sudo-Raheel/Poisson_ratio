...
The code given here implements the models discussed in the following paper. It shows the application of semi-supervised anomaly detection algorithms for Material Science Problem
